 ...
 * @author Ami G
 */
public class CaloriesAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public CaloriesAdapter(Context context, List<T> dataItems, int layoutResource,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            holder.caloriesListLayout = (RelativeLayout) v.findViewById(R.id.caloriesListLayout);
        ...
        if(position + 1 == getCount())
            holder.caloriesListLayout.setBackgroundResource(R.drawable.rectangle_bottom);
        else
            holder.caloriesListLayout.setBackgroundResource(R.drawable.bottom_line);
    ...
    public CaloriesAdapter<T> setAlternatingBackground(int oddColorRes, int evenColorRes) {
