 ...
 * @author Ami G
 */
public class WorkoutAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public WorkoutAdapter(Context context, List<T> dataItems, int layoutResource,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            holder.tvListWorkout = (TextView) v.findViewById(R.id.tvListWorkout);
        ...
        Typeface typeface = Typeface.createFromAsset(mContext.getAssets(), "fonts/comic-sans-ms.ttf");
        holder.tvListWorkout.setTypeface(typeface);
    ...
    public WorkoutAdapter<T> setAlternatingBackground(int oddColorRes, int evenColorRes) {
