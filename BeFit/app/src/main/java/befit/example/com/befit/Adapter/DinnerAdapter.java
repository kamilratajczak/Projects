 ...
 * @author Ami G
 */
public class DinnerAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public DinnerAdapter(Context context, List<T> dataItems, int layoutResource,
    ...
    public DinnerAdapter<T> setAlternatingBackground(int oddColorRes, int evenColorRes) {
