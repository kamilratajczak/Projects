...
if(isset($_SESSION['login'])){
	header('Location: s-koszulki-zalogowany.php');
}
...
<div id = "container">
	...
	<div id = "content">
		...
		$query = "SELECT * FROM `produkty` WHERE `kategoria` = 'Sportowe koszulki'";
...
if ($result->num_rows > 0) {
	...
	if($row["xl"]>0)
		...
		echo "<a href = 'produkt.php?id={$row['id']}' class = 'linki'><div class = 'produkt'><img src =" . $row["duzezdjecie"] . " width='176' height='234'></div></a>";
