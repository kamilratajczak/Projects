...
if(isset($_SESSION['login'])){
	header('Location: koszyk-zalogowany.php');
}
...
if(isset($_SESSION['id'])){
echo "<tr>";	
echo "<th><a href = 'produkt.php?id=$id'class = 'linki1'><img src =" . $row["duzezdjecie"] . " width='88' height='117'></img></a></th>";
echo "<th>" . $row['kategoria'] . "</th>";
echo "<th><a href = 'produkt.php?id=$id'class = 'linki1'>" . $row['firma'] . " " . $row['model'] . "</a></th>";
...
if(isset($_SESSION['id1'])){
echo "<tr>";
echo "<th><a href = 'produkt.php?id=$id1'class = 'linki1'><img src =" . $row1["duzezdjecie"] . " width='88' height='117'></img></a></th>";
echo "<th>" . $row1['kategoria'] . "</th>";
echo "<th><a href = 'produkt.php?id=$id1'class = 'linki1'>" . $row1['firma'] . " " . $row1['model'] . "</a></th>";
...
if(isset($_SESSION['id2'])){
echo "<tr>";
echo "<th><a href = 'produkt.php?id=$id2'class = 'linki1'><img src =" . $row2["duzezdjecie"] . " width='88' height='117'></img></a></th>";
echo "<th>" . $row2['kategoria'] . "</th>";
echo "<th><a href = 'produkt.php?id=$id2'class = 'linki1'>" . $row2['firma'] . " " . $row2['model'] . "</a></th>";
...
if(isset($_SESSION['id3'])){
echo "<tr>";
echo "<th><a href = 'produkt.php?id=$id3'class = 'linki1'><img src =" . $row3["duzezdjecie"] . " width='88' height='117'></img></a></th>";
echo "<th>" . $row3['kategoria'] . "</th>";
echo "<th><a href = 'produkt.php?id=$id3'class = 'linki1'>" . $row3['firma'] . " " . $row3['model'] . "</a></th>";
...
if(isset($_SESSION['id4'])){
echo "<tr>";
echo "<th><a href = 'produkt.php?id=$id4'class = 'linki1'><img src =" . $row4["duzezdjecie"] . " width='88' height='117'></img></a></th>";
echo "<th>" . $row4['kategoria'] . "</th>";
echo "<th><a href = 'produkt.php?id=$id4'class = 'linki1'>" . $row4['firma'] . " " . $row4['model'] . "</a></th>";
