...
<div id = "container">
	...
	if($row["xl"]>0)
		...
		$xl = "";
			...
			echo "<div id = 'blad'>Przekroczona liczba produktów w koszyku</div>";
			echo "</div>";
			...
			echo "<div id = 'rozmiar'>Dostępne rozmiary: " . $s . $m . $l . $xl . "</div>";
			echo "<div id = 'opis'>Opis: <br />- Duży nadruk na przodzie bluzy <br /> 
			- Kaptur z kontrastową podszewką <br /> - Ściagacz u dołu oraz przy końcach rękawów <br /> - Wykonana z dbałością o szczegóły <br /> Materiał: 100% bawełna</div>";
			
			echo "<div id = 'wybierzrozmiar'>";
			echo "<div id = 'wybor'>Wybierz rozmiar:</div>";
			echo "<div id = 'form'>";
			echo "<form action='produktdodany.php?id=$id' method ='post'>";
