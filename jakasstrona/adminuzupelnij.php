...
<div id = "container">
	...
	<div id = "bladaccount">
		...
		<div id = "blad">Uzupełnij wszystkie pola</div>
		</div>
		...
		<form action='dodajprodukt.php' method='post' enctype='multipart/form-data'>
		 <select name="kategoria">
			<option value="mspodnie">Męskie spodnie</option>
			<option value="mbluzy">Męskie bluzy</option>
			<option value="mkoszulki">Męskie koszulki</option>
			<option value="mbuty">Męskie buty</option>
			<option value="dspodnie">Damskie spodnie</option>
			<option value="dbluzy">Damskie bluzy</option>
			<option value="dkoszulki">Damskie koszulki</option>
			<option value="sspodnie">Sportowe spodnie</option>
			<option value="sbluzy">Sportowe bluzy</option>
			<option value="skoszulki">Sportowe koszulki</option>
			<option value="gpaski">Gadżety  paski</option>
			<option value="gportfele">Gadżety  portfele</option>
			<option value="gplecaki">Gadżety  plecaki</option>
			<option value="gsluchawki">Gadżety  słuchawki</option>
		</select> <br />
