...
function noneError()
{
	document.getElementById('bladaccount2').style.display = 'none';
}
...
<div id = "container">
	...
	<div id = "bladaccount2">
		...
		<div id = "blad">Dane produktu zostały zaktualizowane</div>
		</div>
		...
		<h2 class = "srodek">Kliknij na zdjęcie produktu, który chcesz edytować</h2>
		<?PHP
		...
		echo "<tr>";
		echo "<th><a href='edycja.php?id=$idproduktu'><img src =" . $row["duzezdjecie"] . " width='88' height='117'></img></a></th>";
		...
		echo "<th><a href = 'usun.php?id=$idproduktu' class = 'linki1'><span class='closeU'>&times;</span></a></th>";
		echo "</tr>";
		}
		}
		echo "</table>";
