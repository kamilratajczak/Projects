...
if(isset($_SESSION['login'])){
	header('Location: d-buty-zalogowany.php');
}
...
<div id = "container">
	...
	<div id = "content">
		...
		$query = "SELECT * FROM `produkty` WHERE `kategoria` = 'Damskie buty'";
...
if ($result->num_rows > 0) {
	...
	for($i=0; $i<$result->num_rows; $i++){
		...
		echo "<a href = 'produkt.php?id={$row['id']}' class = 'linki'><div class = 'produkt'><img src =" . $row["duzezdjecie"] . " width='176' height='234'> </img></div></a>";
		echo "<div class = 'szczegoly'>" . $row["firma"] . "<br />" . $row["model"] .	 "<br />" . $r40 . $r41 . $r42 . "<br />" . $row["cena"] . " zł" . "</div>";
		echo "</div>";
